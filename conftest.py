"""Configuration pytest globale pour le catalogue kubernetes-dsoxlab-training.

Repris tel quel du catalogue Linux, qui est la reference : meme moteur, meme
mecanique de connexion. Ne pas le reecrire, le faire diverger couterait plus
que le peu qu'il contient de specifique.
...
def lab_target_host(default: str) -> str:
    ...
    Usage dans un test::
        ...
        TARGET_HOST = lab_target_host("k8s-cp.lab")
    """
