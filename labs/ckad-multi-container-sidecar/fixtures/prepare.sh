#!/usr/bin/env bash
# Pose la situation : un namespace sans le Pod demandé.
#
...
kubectl -n lab delete pod app-with-sidecar --ignore-not-found --wait=true

echo "Situation posée : le namespace lab attend le Pod app-with-sidecar."
